...
//**** Add****/
router.post(p.add, upload.single('image'), schemaValidator(signUpSchema),async (req: any, res: Response) => {
    const data = await userController.addUser(req.body, req.file, req.headers);
